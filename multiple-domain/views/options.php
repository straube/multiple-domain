...
<p class="description">
    <?php _e('When enabled, adds canonical link tags to pages. The domain for canonical links will be the original domain where WordPress is installed. You may want to keep this option unchecked if you have a SEO plugin (e.g. Yoast) installed.', 'multiple-domain'); ?>
</p>
